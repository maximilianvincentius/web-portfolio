...
const ExpandableText = ({ text, limit = 200 }) => {
  ...
  return (
    ...
    >
      {" "}
      <div ref={contentRef} className="text-sm leading-relaxed text-gray-400">
        {" "}
...
const ProjectCard = ({ project, index }) => {
  return (
    <motion.article className=" group relative flex h-full flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-xl ">
      {" "}
      {/* Project Image */}{" "}
